...
My Presentation Light contains feature **Visual Attach Tooltip**. Attaching is done with just one click. Select the item to which it’s attached tooltip and jQuery selector completes itself.
