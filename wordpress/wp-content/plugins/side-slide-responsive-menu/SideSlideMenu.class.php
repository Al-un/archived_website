...
class SideSlideMenu
{
	...
	public static function addSideSlideScripts() {
		...
		wp_enqueue_style( 'sideslidemenucss', plugins_url() . '/sideslidemenu/css/sideslidemenu.css');
		wp_enqueue_script( 'sideslidemenujs', plugins_url() . '/sideslidemenu/js/sideslidemenu.min.js' , array(), '1.0', true );
		wp_enqueue_script( 'hammer', plugins_url() . '/sideslidemenu/js/hammer.min.js' , array(), '1.0', true );
	}
	...
	public static function ssmAdminScript() {
		...
		wp_enqueue_style( 'fontawesome', 'http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css');
		wp_enqueue_script( 'sideslidemenuAdmin', plugins_url() . '/sideslidemenu/js/sideslideadmin.js' , array(), '1.0', true );
		wp_enqueue_script( 'jscolor', plugins_url() . '/sideslidemenu/jscolor/jscolor.js' , array(), '1.0', true );
	}
