...
class mythemes_admin
{
    ...
    {   
        ...
        echo '<h1>' . __( 'Latest from our Portfolio' , 'cannyon' ) . '</h1>';
        echo '<p>' . mythemes_core::author( 'description' ) . '</p>';
        echo '<p><span>' . __( 'Take a look at our works and projects, you can find something interesting for you !', 'cannyon' ) . '</span></p>';
        echo '</div>';
