...
if(empty($_POST['team_hidden']))
	...
	define('TEAM_SPECIAL_SECRET_KEY', '54ea2b2dded527.18658902'); 
	define('TEAM_LICENSE_SERVER_URL', 'http://paratheme.com'); 
	define('TEAM_ITEM_REFERENCE', 88);
	define('TEAM_LICENSE_KEYS_PAGE', 'http://paratheme.com/license-keys/');
