...
if(empty($_POST['team_hidden']))
	...
	{	
		if($_POST['team_hidden'] == 'Y') {
			...
			if(empty($_POST['team_themes']))
				{
					$_POST['team_themes'] = array();
				}
			...
			$team_member_social_icon = stripslashes_deep($_POST['team_member_social_icon']);
			update_option('team_member_social_icon', $team_member_social_icon);			
...
<div class="wrap">
    ...
    <div class="para-settings team-settings">
        ...
        <ul class="tab-nav"> 
            ...
            <li nav="2" class="nav2">Help & Support</li>    
        </ul> <!-- tab-nav end --> 
		<ul class="box">
			...
			$team_member_social_field = array_merge($team_member_social_field,$default_social_field);
            ...
            foreach ($team_member_social_field as $value) {
                if(!empty($value))
                    ...
                    <td>
                    <span style=" <?php if(!empty($team_member_social_icon[$value])) echo 'background:url('.$team_member_social_icon[$value].') no-repeat scroll 0 0 rgba(0, 0, 0, 0);';  ?>" title="Icon for this field." class="team_member_social_icon <?php if(empty($team_member_social_icon[$value])) echo 'empty_icon';?>" icon-name="<?php echo $value; ?>"> </span>
                    
                    
                    <input class="team_member_social_icon team_member_social_icon_<?php echo $value; ?>" name="team_member_social_icon[<?php echo $value; ?>]" type="hidden" value="<?php if(isset($team_member_social_icon[$value])) echo $team_member_social_icon[$value]; ?>" />
 ...
 <script>
	...
	jQuery(document).ready(function() {
		...
		jQuery("#team_member_social_field").tableDnD();
