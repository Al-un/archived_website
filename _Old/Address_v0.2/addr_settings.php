...
// ==================================== SQL TABLES ================================ //
// ================================================================================ // 
  $sqlTable_AddrType          = "_AddrType";
  $sqlTable_AddrCate          = "_AddrCate";
  $sqlTable_AddrSubCate       = "_AddrSubCate";
  $sqlTable_AddrCountry       = "_AddrCountry";
  $sqlTable_AddrArea          = "_AddrArea";
  $sqlTable_AddrCity          = "_AddrCity";
  // $sqlTable_AddrRelCate       = "_AddrRelCate";
  // $sqlTable_AddrRelCity       = "_AddrRelCity";
  $sqlTable_AddrItem          = "_AddrItem";
  $sqlTable_AddrItemCate      = "_AddrItemCate";
  $sqlTable_AddrItemCity      = "_AddrItemCity";
  $sqlTable_AddrTranslateShort= "_AddrTranslateShort";
  $sqlTable_AddrTranslateLong = "_AddrTranslateLong";
